...
import zs.xmx.mvpframe.dagger.component.DaggerBaseComponent;
 ...
 *
 */
public abstract class BaseActivity extends AppCompatActivity implements View.OnClickListener, IView, NetWorkReceiver.onNetWorkStateChangedListener {
     ...
     */
    @Override
    public void onNetWorkStateChanged(@NonNull String mNetWorkTypeName) {
     ...
     */
    @Override
    public void urlRequestSuccess(@NotNull Object result) {
