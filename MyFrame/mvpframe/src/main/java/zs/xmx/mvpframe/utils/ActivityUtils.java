...
public final class ActivityUtils {
    ...
    private static Context mContext = ProjectInit.getApplicationContext();
    ...
    public static boolean isActivityExists(@NonNull final String packageName,
        ...
        return !(mContext.getPackageManager().resolveActivity(intent, 0) == null ||
                ...
                mContext.getPackageManager().queryIntentActivities(intent, 0).size() == 0);
    }
    ...
    public static void startActivity(@NonNull final String pkg,
        ...
        startActivity(mContext, null, pkg, cls, null);
    }
    ...
    public static void startActivity(@NonNull final String pkg,
                                     @NonNull final String cls,
                                     @NonNull final Bundle options) {
        startActivity(mContext, null, pkg, cls, options);
    }
    ...
    public static void startActivity(@NonNull final Bundle extras,
                                     @NonNull final String pkg,
                                     @NonNull final String cls) {
        startActivity(mContext, extras, pkg, cls, null);
    }
    ...
    public static void startActivity(@NonNull final Bundle extras,
                                     ...
                                     @NonNull final String cls,
                                     @NonNull final Bundle options) {
        startActivity(mContext, extras, pkg, cls, options);
    }
    ...
    public static Activity getTopActivity() {
        if (LifeCycleManager.sTopActivityWeakRef != null) {
            Activity activity = LifeCycleManager.sTopActivityWeakRef.get();
            if (activity != null) {
                return activity;
            }
        }
        return LifeCycleManager.sActivityList.get(LifeCycleManager.sActivityList.size() - 1);
    }
    ...
    public static void finishAllActivities() {
        List<Activity> activityList = LifeCycleManager.sActivityList;
